...
class MovieRecommendation:
    ...
    def get_recommendations_user_based(self, user: User, weight=3, maximum=30) -> List[Movie]:
        """
        User based 알고리즘으로 추천 영화 리스트를 반환합니다.

        :param user: 영화 추천 대상 사용자입니다.
        :param weight: 허용할 별점의 가중치입니다. 기본값은 3입니다.
        ...
        ## TODO: ERR - 중복된 사용자가 나타남에 따라 set() 으로 변경함.
        ...
        return list(map(lambda x : x[0], movies_list))[:maximum]
